...
wrangler d1 execute gaspe-db --remote --file workers/migrations/0013_seed_organization_vessels.sql
```

### Option B: Cloudflare Dashboard

1. Go to **Workers & Pages > D1 > gaspe-db > Console**
2. Paste each migration SQL file content in order (0001 → 0013)
...
| 0013 | `0013_seed_organization_vessels.sql` | — | Seed initial 110 vessels across 25 compagnies (INSERT OR IGNORE, idempotent, generated by `scripts/build-fleet-seed-sql.ts`) |
