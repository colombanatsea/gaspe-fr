...
| C4 | **Cotisations ENIM 2025/2026 sans attestation** : taux affichés sans lien vers caisse-gens-de-mer.fr ni note sur la classe AT/MP variable par entreprise. | `src/data/ccn3228.ts:506-514` | XS | ⏳ **EN ATTENTE** : direction à choisir entre (a) lien `caisse-gens-de-mer.fr` page taux à jour, (b) lien arrêté annuel Legifrance taux 2025/2026 à pointer, (c) maintien de la mention actuelle sans attestation. |
