...
- **Version**: v2.29.0 (session 38 totalement bouclée – 15 PR mergées #45→#59. Lots A/B/C : votes AG-NAO complet, CSV import flotte, Hydros publication auto câblée)
...
## Database (D1 – 22 tables, migrations 0001-0019 prêtes ; 0001-0007 appliquées en prod, 0008-0019 à appliquer au prochain merge main)
| Table | Description |
|-------|-------------|
