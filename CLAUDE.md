...
- **Version**: v2.30.2 (session 39 : RBAC granulaire staff GASPE + retrait fuel du partage cross-compagnies + refactoring code mort. Total session 38+39 : 19 PR mergées #45→#63)
...
## Database (D1 – 22 tables, migrations 0001-0020 prêtes ; 0001-0007 appliquées en prod, 0008-0020 à appliquer au prochain merge main)
| Table | Description |
|-------|-------------|
