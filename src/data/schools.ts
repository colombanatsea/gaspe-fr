...
export const SCHOOLS: School[] = [
  ...
  /* ---------- 4 sites ENSM ---------- */
  {
    ...
    slug: "ensm-le-havre",
    kind: "ensm",
    name: "ENSM – Site du Havre",
    shortName: "ENSM site du Havre",
    city: "Le Havre",
    region: "Normandie",
    postalCode: "76600",
    lat: 49.4938,
    ...
    description: "Siège de l'ENSM. Formation Ingénieur Officier de la Marine Marchande (polyvalent pont + machine, 5 ans).",
  ...
  },
  {
    ...
    slug: "ensm-marseille",
    kind: "ensm",
    name: "ENSM – Site de Marseille",
    shortName: "ENSM site de Marseille",
    city: "Marseille",
    ...
    lng: 5.3698,
    website: "https://www.supmaritime.fr/",
    description: "Site méditerranéen de l'ENSM. Formations officier monovalent pont ou machine (3 ans) et licence pro capitaine 500.",
    formations: [ENSM_OFFICIER_1, ENSM_OFFICIER_CHEF, ENSM_LIC_PRO],
  },
  {
    id: "ensm-nantes",
    slug: "ensm-nantes",
    kind: "ensm",
    name: "ENSM – Site de Nantes",
    shortName: "ENSM site de Nantes",
    city: "Bouguenais",
    region: "Pays de la Loire",
    postalCode: "44340",
    lat: 47.1500,
    lng: -1.6066,
    website: "https://www.supmaritime.fr/",
    description: "Site nantais de l'ENSM. Spécialité génie maritime, ingénierie navale et énergies marines renouvelables.",
  ...
  },
  {
    ...
    kind: "ensm",
    name: "ENSM – Site de Saint-Malo",
    shortName: "ENSM site de Saint-Malo",
    city: "Saint-Malo",
    region: "Bretagne",
    postalCode: "35400",
    lat: 48.6358,
    lng: -2.0080,
    website: "https://www.supmaritime.fr/",
    description: "Site breton de l'ENSM. Formations officier polyvalent et licence pro capitaine 500.",
