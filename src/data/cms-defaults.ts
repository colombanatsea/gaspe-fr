...
export const CMS_DEFAULTS: Record<string, Record<string, string>> = {
  ...
  "transition-ecologique": {
    "page-header-title": "Transition Écologique",
    ...
    "intro-title": "Cap sur la décarbonation du maritime côtier",
    "intro-description": "<p>Navires hybrides, propulsion 100 % électrique, biocarburants, renouvellement de flotte accéléré : les compagnies du GASPE sont pionnières. L'AAP ADEME 2026 finance jusqu'à 6 M€ par projet pour la décarbonation de vos navires.</p>",
    "deadline-text": "Clôture : 6 juillet 2026 · Budget total : 70 M€",
    ...
    "simulator-title": "Simulateur de pré-dossier ADEME",
    "simulator-description": "Estimez vos aides, calculez votre scoring et préparez votre candidature en 30 minutes. Le simulateur couvre l'électrique, le biocarburant, le dual-fuel et l'optimisation opérationnelle.",
