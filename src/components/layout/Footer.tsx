...
const D = (s: string) => getCmsDefault("footer", s);

export function Footer() {
  const newsletterTitle = useCmsContent("footer", "newsletter-title", D("newsletter-title"));
  const newsletterCta = useCmsContent("footer", "newsletter-cta", D("newsletter-cta"));
  const linkedinUrl = useCmsContent("footer", "social-linkedin", D("social-linkedin"));
  const contactEmail = useCmsContent("footer", "contact-email", D("contact-email"));
