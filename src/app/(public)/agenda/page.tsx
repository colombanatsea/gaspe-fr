          ...
          <div className="space-y-4">
            {events.map((ev) => {
              ...
              return (
                <article
                  key={ev.id}
                  className="flex gap-6 rounded-2xl bg-white p-6 border border-[var(--gaspe-neutral-200)] border-l-[3px] border-l-[var(--gaspe-teal-600)] hover:border-[var(--gaspe-teal-200)] transition-colors"
                >
                  {/* Date block */}
