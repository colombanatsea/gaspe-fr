            ...
            {editing ? (
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      {companyLogo && (
                        <Image src={companyLogo} alt="Logo entreprise" width={64} height={64} unoptimized loading="lazy" className="h-16 w-16 rounded-lg object-contain border border-[var(--gaspe-neutral-200)]" />
                      )}
                      <div>
                        <input
                          type="file"
              ...
              <Card>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    {user.companyLogo ? (
                      <Image src={user.companyLogo} alt={`Logo ${user.company ?? ""}`} width={64} height={64} unoptimized loading="lazy" className="h-16 w-16 rounded-lg object-contain border border-[var(--gaspe-neutral-200)]" />
                    ) : (
