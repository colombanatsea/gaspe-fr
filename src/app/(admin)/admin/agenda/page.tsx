...
const SEED_EVENTS: AgendaEvent[] = [
  ...
  },
  {
    id: "event-seed-3",
    title: "NAVEXPO 2026",
    description: "Le salon de l'innovation maritime – expertises, innovations technologiques et solutions de décarbonation pour l'industrie maritime de demain. Expositions statiques et démonstrations dynamiques (drones de surface, essais en mer). Participation GASPE dans le cadre de la promotion de la filière des armateurs côtiers.",
    startDate: "2026-06-02",
    endDate: "2026-06-04",
    location: "Lorient",
    address: "10 rue Jean Stéphan, 56100 Lorient",
    eventUrl: "https://navexpo.com/fr/",
    published: true,
  },
  {
    id: "event-seed-4",
    title: "Festival Les Insulaires – Îles du Ponant",
    description: "13ᵉ édition du festival Les Insulaires, rendez-vous annuel des habitants des îles du Ponant (Yeu, Sein, Molène, Ouessant, Houat, Hoëdic, Groix, Belle-Île, Bréhat, Batz, Aix, Arz, Chausey). Concerts, régates d'avirons, marché de producteurs, débats et rencontres. Participation GASPE sur la continuité territoriale maritime. Événement gratuit, ouvert à tous.",
    startDate: "2026-09-18",
    endDate: "2026-09-20",
    location: "Île d'Yeu",
    address: "Port-Joinville, 85350 L'Île-d'Yeu",
    eventUrl: "https://lesinsulaires.com/",
    published: true,
  },
  {
    id: "event-seed-5",
    title: "Congrès international Sciences aquatiques – 6ᵉ édition",
    description: "6ᵉ édition du Congrès international sur les sciences aquatiques organisé par Archipel Développement (SEM de Saint-Pierre-et-Miquelon). Rencontres d'experts autour des sciences aquatiques, ressources halieutiques et enjeux maritimes atlantiques. Participation GASPE au titre de la représentation des armateurs ultramarins.",
    startDate: "2026-10-04",
    endDate: "2026-10-09",
    location: "Saint-Pierre-et-Miquelon",
    address: "Saint-Pierre, 97500 Saint-Pierre-et-Miquelon",
    eventUrl: "https://www.archipel-developpement.fr/",
    published: true,
  },
];
