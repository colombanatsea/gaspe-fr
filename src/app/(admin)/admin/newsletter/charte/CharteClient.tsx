        ...
        <div key={s.id} className="rounded-2xl bg-background border border-border-light p-4">
          ...
          {s.type === "richtext" ? (
            ...
            <div className="flex items-start gap-3">
              {s.content && <Image src={s.content} alt="Logo" width={56} height={56} className="h-14 w-14 rounded-lg object-contain border border-border-light" loading="lazy" unoptimized />}
              <input
                type="url"
                value={s.content}
